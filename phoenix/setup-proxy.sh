...
sed -i "s/username = \".*\";/username = \"$user\";/" "$ROOT/configuration.nix"
sed -i "s/password = \".*\";/password = \"$password\";/" "$ROOT/configuration.nix"
sed -i "s/domain = \".*\";/domain = \"$domain\";/" "$ROOT/configuration.nix"
